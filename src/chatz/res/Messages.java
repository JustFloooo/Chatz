...
public class Messages {
    ...
    private static final String header1 = fst + "Willkommen " + snd + "%player_name% " + fst + "auf dem ";
    private static final String servername = Symbols.getStar() + ChatColor.GOLD + " PROBLEMSERVER " + Symbols.getStar() + "";
